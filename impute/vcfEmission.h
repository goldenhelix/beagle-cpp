...
public:
  ...
  BitSetRefGTSharedData(const Samples &samples)
    : MarkerSharedData(), samples(samples) {}
  BitSetRefGTSharedData(const BitSetRefGTSharedData &other)
    : MarkerSharedData(other)
  {
...
public:
  ...
  BitSetGTSharedData(const Samples &samples)
    : BitSetRefGTSharedData(samples) {}
  BitSetGTSharedData(const BitSetGTSharedData &other)
    : BitSetRefGTSharedData(other)
  {
