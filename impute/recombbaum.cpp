...
RecombSingleBaumLevel& RecombSingleBaumLevel::operator=(const RecombSingleBaumLevel& other)
{
  // autogenerated assignment operator wont do const casts 
  const_cast<SamplerData&>(_samplerData) = other._samplerData;
